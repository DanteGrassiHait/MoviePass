                              ...
                              <div class="form bg-dark-transparent rounded">                 
                                   ...
                                   ?>
                                        ...
                                        <div class="form-group">
                                             ...
                                             <input type="password" name="password" class="form-control form-control-lg heading nospace" >
                                        </div>
                                        <div class="btn_cont">
                                        <button class="btn btn-primary btn-block btn-lg heading nospace" type="submit">Login</button>
                                        </div>
                                   </form>
                                   <a href="<?php echo FRONT_ROOT;?>User/ShowRegisterView" class="login-form bg-dark-alpha p-5 bg-light">
                                   <div class="btn_cont">
                                        <button class="btn btn-primary btn-block btn-lg heading nospace" >Register</button>
                                   </div>
                                   </a>
                              </div>
                    </div>
